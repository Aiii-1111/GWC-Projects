...
X_train, X_validate, y_train,y_validate = train_test_split(X_train,y_train,test_size = 40,random_state=42, stratify = y_train)
...
##Create Neural Net Model obj##
neural_net_model = MLPClassifier( hidden_layer_sizes=(15),random_state=42,tol=0.005)
...
##Predicting data and measuring accuracy##
...
for true, pred in zip(y_validate, y_pred_train):
